    ...
    <main className="min-h-screen">
      ...
      <section className="h-screen flex flex-col items-center justify-center">
        <div className="text-center text-white">
          <SplitText text="Priyanshu Gupta" className="text-2xl font-bold font-necosmic mb-4 mt-8" />
      ...
      <section id="about" className="flex flex-col py-16 px-4 md:px-8 lg:px-16 text-white">
      ...
      <section id="skills" className="flex flex-col py-16 px-4 md:px-8 lg:px-16 text-white">
      ...
      <section id="social" className="h-screen px-4 md:px-8 lg:px-16 text-white">
