      ...
      <section id="skills" className="py-32 px-4 md:px-8 lg:px-16 text-white">
        ...
        <div className="flex flex-wrap justify-center gap-4 max-w-3xl mx-auto">
          {["Python", "JavaScript", "React", "Next.js", "Tailwind CSS", "UI/UX Design"].map(
            (skill) => (
              <div key={skill} className="px-4 py-2 rounded-full text-sm border border-[#353535] text-[#7A7A7A] bg-[#111111]/90 shadow-inner hover:scale-105 transition-transform duration-200">
                {skill}
              </div>
            ),
          )}
