              ...
              <div className="space-y-12">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8">
                  <button
                    ...
                    className={`group relative flex items-center gap-4 px-10 py-5 rounded-full font-bold text-lg transition-all duration-300 shadow-xl hover:scale-[1.02] active:scale-[0.98] ${
                      isDark
        ...
        <footer className="mt-24 md:mt-32 flex items-center justify-between border-t border-border pt-12">
          <div className="flex items-center gap-10">
            <button
              ...
              disabled={page === 0}
              className={`group flex items-center gap-2 text-sm font-bold transition-all duration-200 hover:text-foreground disabled:opacity-0 disabled:pointer-events-none ${
          ...
          <button
            ...
            className={`group flex items-center gap-4 px-8 py-4 rounded-full font-bold text-sm transition-all active:scale-[0.95] disabled:opacity-0 disabled:pointer-events-none ${
              isDark
